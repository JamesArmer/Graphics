...
void Player::animatedGoalkeeper(float joint, float armY) {
    glPushMatrix();
...
void Player::animatedPlayer(float joint, float legX, bool isBlue) {
    glPushMatrix();
    glScalef(0.08f, 0.08f, 0.08f);
    glTranslatef(0.f, 18.f, 0.f);
    glPushMatrix();//1 - head
...
void Player::person(bool isBlue) {
    glPushMatrix();
    glScalef(0.08f, 0.08f, 0.08f);
    glTranslatef(0.f, 18.f, 0.f);
    glPushMatrix();//1 - head
...
void Player::cylinder(float h, float r) {
...
void Player::Box(float sx, float sy, float sz) {
    glPushMatrix();
    glScalef(sx, sy, sz);
    glutSolidCube(1.f);
    glPopMatrix();
